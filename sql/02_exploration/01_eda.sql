...
-- Purpose: Determine if fraudulent transactions differ in amount
-- from normal transactions within TRANSFER and CASH_OUT
-- =============================================
...
-- Purpose: Test whether higher amount transactions
-- have disproportionately higher fraud rates
